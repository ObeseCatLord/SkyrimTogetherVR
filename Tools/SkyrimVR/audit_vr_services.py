...
REQUIRED_REMOTE_AVATAR_COMPONENT_TOKENS = {
    ...
    "Code/client/Services/VRAvatarService.h": (
        ...
        "SpatialTransferPendingElapsed",
        "PendingSpatialTargetCellFormId",
        "RespawnRequested",
    ),
    "Code/client/Services/Generic/VRAvatarService.cpp": (
        ...
        "GameplayBridge::CommandKind::ApplyRemoteAnimationGraphChunk",
        ...
        "remote avatar spatial-transfer acknowledgement timed out",
        "remote avatar spatial-transfer acknowledgement was rejected or mismatched",
    ),
    ...
    "Code/vr_gameplay_bridge/AvatarManager.cpp": (
        ...
        "ApplyRemoteAnimationGraphChunk",
        "SetPosition",
        "SetAngle",
        "SetScale",
        "CanCreateAfterDestroyedGeneration",
