...
DLL_BATCH_TOKENS = (
    ...
    "STVR_ENV_RESULT",
    "BuildSkyrimTogetherVR-Windows.ps1",
    "STVR_TARGETS=SkyrimTogetherVRVrikBridge,SkyrimTogetherVRHiggsBridge,SkyrimTogetherVRPlanckBridge,ImmersiveElf",
...
AVATAR_SYNC_BATCH_TOKENS = (
    ...
    "STVR_ENV_RESULT",
    "BuildSkyrimTogetherVR-Windows.ps1",
    "-Targets SkyrimTogetherVRClientAvatarSync,SkyrimVRImmersiveLauncherAvatarSync,SkyrimTogetherVRVrikBridge,SkyrimTogetherVRHiggsBridge,SkyrimTogetherVRPlanckBridge,ImmersiveElf,TPProcess",
...
GAMEPLAY_BATCH_TOKENS = (
    ...
    "STVR_ENV_RESULT",
    "BuildSkyrimTogetherVR-Windows.ps1",
    "-Targets SkyrimTogetherVRGameplayClient,SkyrimVRImmersiveLauncherGameplay,SkyrimTogetherVRVrikBridge,SkyrimTogetherVRHiggsBridge,SkyrimTogetherVRPlanckBridge,ImmersiveElf,TPProcess",
