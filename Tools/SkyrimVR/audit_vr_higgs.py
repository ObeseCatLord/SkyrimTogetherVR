...
REQUIRED_TOKENS = {
    ...
    "Code/server/Services/VRHiggsRelayService.h": (
        ...
        "LastTerminalMutationSequence",
        "LastObservationRelayTick",
        "HasObservationSequence",
        "OnPlayerLeave",
        "BuildRelayDecision",
        "PrepareObjectAuthority",
        "CommitRelayDecision",
