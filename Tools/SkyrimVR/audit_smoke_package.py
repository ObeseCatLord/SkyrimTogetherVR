...
REQUIRED_BUILT_PACKAGE_AUDIT_TOKENS = (
    ...
    "sourceProvenance",
    "packageFileSha256",
    "build manifest artifact SHA-256 mismatch",
    "build manifest package SHA-256 mismatch",
    "Package self-test did not reject a tampered staged helper.",
    "Package self-test did not reject a dirty source tree.",
    "Package self-test did not reject an unavailable network version.",
    "Package self-test did not reject a mismatched network version.",
    "Package self-test did not reject a tampered runtime artifact.",
